...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20231206221743_post11111")]
    partial class post11111
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.models.applecationuser", b =>
                {
                    b.HasOne("WebApplication1.models.post", null)
                        .WithMany("UserMakeDislikeIds")
                        .HasForeignKey("postId");

                    b.HasOne("WebApplication1.models.post", null)
                        .WithMany("UserMakeLikeIds")
                        .HasForeignKey("postId1");

                    b.HasOne("WebApplication1.models.post", null)
                        .WithMany("UserShareIds")
            ...
            modelBuilder.Entity("WebApplication1.models.post", b =>
                {
                    ...
                    b.Navigation("UserMakeDislikeIds");

                    b.Navigation("UserMakeLikeIds");

                    b.Navigation("UserShareIds");
                });
